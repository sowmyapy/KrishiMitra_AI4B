...
async def make_advisory_call():
    ...
    try:
        ...
        print(f"    TWILIO_PHONE_NUMBER=your_twilio_number")
        return 1
  ...
  3. Use Twilio TwiML Bins (simple testing):
    ...
    if not webhook_url:
        ...
        print(f"  Skipping actual call")
        print(f"\n  To test without webhook, you can:")
        print(f"  1. Save the TwiML to a Twilio TwiML Bin")
        print(f"  2. Use Twilio Console to make a test call")
        return 0
    ...
    try:
        ...
        print(f"  You will hear the advisory in Hindi.")
